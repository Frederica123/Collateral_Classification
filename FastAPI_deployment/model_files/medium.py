...
loaded_svm = joblib.load("model_joblibs/" + config['medium_joblib'])
# original_df = pd.read_csv('before_smote_standard_token_from_6.csv',index_col = 0)
description = pd.read_json(config['description_medium'], encoding = 'utf-8-sig')

def medium_predict(test_data):
